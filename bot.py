#!/usr/bin/env python3
"""Main bot class — Telegram music-link converter bot."""
...
from config import (
    Platform, SongInfo, MusicLinks,
    CACHE_TTL_SUCCESS, CACHE_TTL_FAILURE, CACHE_TTL_INFO
)
from cache import SmartCache
from http_client import HTTPClient
from parsers import TextNormalizer, ParsingUtils, SpotifyParser, YouTubeParser, AppleMusicParser
from matcher import SearchEngine, MatchValidator
